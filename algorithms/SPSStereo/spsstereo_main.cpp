...
int main(int argc, char* argv[]) {
	...
	std::cout << images.is_open() << std::endl;
    std::getline(images, leftImageFilename);
	std::cout << leftImageFilename << std::endl;
    std::getline(images, rightImageFilename);
	std::cout << rightImageFilename << std::endl;
    while (!images.eof())
    {
		...
		std::cout << "Processing Time for " << leftImageFilename << ": " << duration.count() << " ms." << std::endl;
