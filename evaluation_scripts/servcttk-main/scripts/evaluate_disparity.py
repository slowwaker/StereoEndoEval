...
if __name__ == "__main__":
    ...
    # path_dict['disparity'].pop(-1)
    # path_dict['occ'].pop(-1)

    # print(path_dict['disparity'])
    # print(path_dict)
    ...
    for occlusions in [True, False]:
        for gt_disparity_p, occ_p in zip (path_dict['disparity'], path_dict['occ']):
            ...
            disparity_error_df = pd.concat([disparity_error_df, pd.DataFrame([metrics])], ignore_index=True)
            # print(disparity_error_df)
