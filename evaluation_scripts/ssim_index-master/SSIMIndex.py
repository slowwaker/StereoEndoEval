...
if __name__=="__main__":
    ...
    # for x in range(1,9):
    # # opencv image load
    #     I1 = cv2.imread('J:/THESIS/experiment/serv-ct/SERV-CT/Experiment_1/Left_rectified/' + "{:03d}".format(x) + ".png")
    #     I2 = cv2.imread('J:/THESIS/Models/servcttk-main/scripts/Disparities/CRD_Fusion/' + "{:03d}".format(x) + ".png")
    ...
    # for x in range(9,17):
    # # opencv image load
    #     I1 = cv2.imread('J:/THESIS/experiment/serv-ct/SERV-CT/Experiment_2/Left_rectified/' + "{:03d}".format(x) + ".png")
    #     I2 = cv2.imread('J:/THESIS/Models/servcttk-main/scripts/Disparities/CRD_Fusion/' + "{:03d}".format(x) + ".png")
    #     # I2 = cv2.imread('./blur.png')
    #     # I2 = cv2.resize(I2, I1.shape[0:2])
    #     # print(I1.shape, I2.shape) # returns (256,256,3)
    ...
    # opencv image load
        I1 = cv2.imread('J:/THESIS/Models/SCARED_main/scared/Experiment_1/Left_Rectified/' + "{:03d}".format(x) + ".png")
        I2 = cv2.imread('J:/THESIS/Models/SCARED_main/scripts/Disparities/CRD_Fusion/' + "{:03d}".format(x) + ".png")
        # I2 = cv2.imread('./blur.png')
        # I2 = cv2.resize(I2, I1.shape[0:2])
        # print(I1.shape, I2.shape) # returns (256,256,3)
